...
(n=!0,k.style.display="block");"none"==this.getCompStyle(l).display&&(q=!0,l.style.display="block");if(0==h){var r=k.min=l.min=this.scGetMin(e,k,l,m,1),p=k.max=l.max=this.scGetMax(e,k,l,m,1);a?this.scRelease(l):thisEvnt.scrollDisable||(this.disableTextSelect(k,!0),this.disableTextSelect(l,!0))}else p=m?Math.round(this.totalItems/(k.offsetHeight/l.offsetHeight)):Math.round(this.totalItems/(k.offsetWidth/l.offsetWidth)),0==p&&(p=0.1),k.concurrent=p,r=k.min=l.min=this.scGetMin(e,l,k,m,p),p=k.max=l.max=
this.scGetMax(e,l,k,m,p),a?this.scRelease(k):thisEvnt.dragDisable||(this.disableTextSelect(k,!0),this.disableTextSelect(l,!1));n&&(k.style.display="none");q&&(l.style.display="none");a||this.addScrollDrag(e,k,l,r,p,m,d[h])}}}};Mg.prototype.refreshScrollDrag=function(){this.initScrollDrag(!0)};
...
c=e.scCheckLimits(c,a.isScroll,0,a.min,a.max),e[d]["frictionInterval"+a.scrollDragStr]=setTimeout(function(){m(a,b,c)},13))}this[a][h+"Disable"]||(c.onmousedown=c.ontouchstart=g,c.onmouseup=c.ontouchend=l);c.evnt=a;c.mg=this;c.itemOut=b;c.itemIn=c;c.vertical=f;c.scrollDragStr=h;c.wheelnum=0;c.friction=this[a][h+"Friction"];c.power=this[a][h+"Power"];c.further=this[a][h+"Further"];this[a][h+"Disable"]||(c.style.cursor=c.mg[a][h+"CursorOff"]);if("scroll"!=h)b.isScroll=c.isScroll=!1,this[a][h+"Wheel"]&&
this.addWheel(c,this.scWheel);else{b.isScroll=c.isScroll=!0;var n=function(a){return(a=a.getBoundingClientRect())?{top:a.top,left:a.left}:{top:0,left:0}};b.onmousedown=b.ontouchstart=function(a){a||(a=window.event);void 0==a.clientX&&(a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY);if(this==this&&!this.itemIn.clicked){var b=this.vertical?a.clientY-n(this).top-this.itemIn.offsetHeight/2:a.clientX-n(this).left-this.itemIn.offsetWidth/2;this.itemIn.startPosX=a.clientX;this.itemIn.startPosY=
