/* minimit-gallery 2.0.10 http://github.com/minimit/minimit-gallery */function Mg(a){this.events=[];this.setSettings(a)}
...
Mg.prototype.initScrollDrag=function(a){for(var c=0,b=this.events.length;c<b;c++){var e=this.events[c];thisEvnt=this[e];for(var d=["scroll","drag"],f=["In","Out"],h=0,g=d.length;h<g;h++){a||(thisEvnt[d[h]+f[0]+"Div"]=document.getElementById(this.reference+"-"+e+"-"+d[h]+f[0]),thisEvnt[d[h]+f[1]+"Div"]=document.getElementById(this.reference+"-"+e+"-"+d[h]+f[1]));var k=thisEvnt[d[h]+f[0]+"Div"],l=thisEvnt[d[h]+f[1]+"Div"],m=thisEvnt[d[h]+"IsVertical"];if(k&&l){var p=!1,q=!1;"none"==this.getCompStyle(k).display&&
(p=!0,k.style.display="block");"none"==this.getCompStyle(l).display&&(q=!0,l.style.display="block");if(0==h){var r=k.min=l.min=this.scGetMin(e,k,l,m,1),n=k.max=l.max=this.scGetMax(e,k,l,m,1);a?this.scRelease(l):(this.disableTextSelect(k,!0),this.disableTextSelect(l,!0))}else n=m?Math.round(this.totalItems/(k.offsetHeight/l.offsetHeight)):Math.round(this.totalItems/(k.offsetWidth/l.offsetWidth)),0==n&&(n=0.1),k.concurrent=n,r=k.min=l.min=this.scGetMin(e,l,k,m,n),n=k.max=l.max=this.scGetMax(e,l,k,m,
n),a?this.scRelease(k):(this.disableTextSelect(k,!0),this.disableTextSelect(l,!1));p&&(k.style.display="none");q&&(l.style.display="none");a||this.addScrollDrag(e,k,l,r,n,m,d[h])}}}};Mg.prototype.refreshScrollDrag=function(){this.initScrollDrag(!0)};
...
f=d.obj,h=a.state.url;arr=f.itemsLink;for(var g=0,k=arr.length;g<k;g++)if(arr[g].href==h)return f.setState(g,d.evnt,!0,!0,!0,!0,"anchor"),f.setDocumentTitle(a.state.title||f.itemsLink[g].title),!0}}}
...
b.min,b.max),b.count+=c-b.num,b.count*=b.power,b.num=c,b.mg.scMove(b,c),b.mg.stopPropagation(a),b.mg.preventDefault(a))}function k(a){a||(a=window.event);void 0==a.clientX?(a.clientX=a.changedTouches[0].clientX,a.clientY=a.changedTouches[0].clientY):"ontouchstart"in window&&void 0==a.touches[0].clientX&&(a.clientX=a.clientY=b.lastClient);var b=document.t,c=b.evnt,d=b.mg,e=b.min,f=b.max,g=b.num;document.onmousemove=null;document.onmouseup=null;document.ontouchmove=null;document.ontouchend=null;b.style.cursor=
d[c][b.scrollDragStr+"CursorOff"];if(b.clicked){if(b.vertical)h=a.clientY-b.startPosY,k=a.clientX-b.startPosX;else var h=a.clientX-b.startPosX,k=a.clientY-b.startPosY;if(30<Math.abs(h)){b.onclick=function(){return!1};var m=!1;b.isScroll?g>=e&&g<=f&&(m=!0):Math.abs(h)<b.swipeDist/2&&Math.abs(k)<Math.abs(h)?(e=Math.abs(f-e)/d.totalItems,g=0>h?g-e:g+e):g<=-e&&g>=-f&&(m=!0);m&&!d[c].disableFriction?l(b,b.friction,g):(d.scMove(b,g,!0),d.scReleaseFraction(b),d.scRelease(b,g));b.mg.stopPropagation(a)}else b.onclick=
function(){},d.scReleaseFraction(b),d.scRelease(b,g);d[c]["clickedInterval"+b.scrollDragStr]=setTimeout(function(){b.clicked=!1},113)}}function l(a,b,c){var d=a.evnt,e=a.mg;a.count*=b;var f=a.count;c+=f;a.num=c;!b||-1<f&&1>f?(e.scReleaseFraction(a),e.scRelease(a,c)):(e.scMove(a,c),c=e.scCheckLimits(c,a.isScroll,0,a.min,a.max),e[d]["frictionInterval"+a.scrollDragStr]=setTimeout(function(){l(a,b,c)},13))}c.onmousedown=c.ontouchstart=function(a){a||(a=window.event);void 0==a&&(a={clientX:this.startPosX,
clientY:this.startPosY});void 0==a.clientX&&(a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY);var b=this.mg,d=this.evnt,e=this.scrollDragStr;document.t=this;document.onmousemove=g;document.onmouseup=k;document.ontouchmove=g;document.ontouchend=k;this.style.cursor=b[d][e+"CursorOn"];this.time=+new Date;this.count=0;this.startPosX=a.clientX;this.startPosY=a.clientY;var f=this.mg.getTransform(this);this.vertical?(this.offsetPos=f?f.top:this.offsetTop,c.swipeDist=this.itemOut.offsetHeight/
...
window.getSelection().removeAllRanges():document.selection&&document.selection.empty()};c.onmouseup=c.ontouchend=k;c.evnt=a;c.mg=this;c.itemOut=b;c.itemIn=c;c.vertical=f;c.scrollDragStr=h;c.wheelnum=0;c.friction=this[a][h+"Friction"];c.power=this[a][h+"Power"];c.further=this[a][h+"Further"];c.style.cursor=c.mg[a][h+"CursorOff"];if("scroll"!=h)b.isScroll=c.isScroll=!1,this[a][h+"Wheel"]&&this.addWheel(c,this.scWheel);else{b.isScroll=c.isScroll=!0;var m=function(a){return(a=a.getBoundingClientRect())?
{top:a.top,left:a.left}:{top:0,left:0}};b.onmousedown=b.ontouchstart=function(a){a||(a=window.event);void 0==a.clientX&&(a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY);if(this==this&&!this.itemIn.clicked){var b=this.vertical?a.clientY-m(this).top-this.itemIn.offsetHeight/2:a.clientX-m(this).left-this.itemIn.offsetWidth/2;this.itemIn.startPosX=a.clientX;this.itemIn.startPosY=a.clientY;b=this.mg.scCheckLimits(b,this.isScroll,0,this.min,this.max);this.itemIn.instantOffsetPos=b;this.mg.scReleaseSet(this,
b);if("touchstart"==a.type)this.itemIn.ontouchstart();else this.itemIn.onmousedown()}return!1};b.evnt=a;b.mg=this;b.itemIn=c;b.itemOut=b;b.vertical=f;b.scrollDragStr=h;b.wheelnum=0;this[a][h+"Wheel"]&&this.addWheel(b,this.scWheel)}b.ondragstart=c.ondragstart=function(a){return!1}};Mg.prototype.scClick=function(a){var c=a.evnt,b=a.itemIn;a=a.scrollDragStr;this[c].startPosX=b.startPosX;this[c].startPosY=b.startPosY;if(void 0!=this[c][a+"Click"])this[c][a+"Click"]()};
Mg.prototype.scMove=function(a,c,b,e){var d=a.evnt,f=a.scrollDragStr,h=a.isScroll,g=a.min,k=a.max,l=this[d][f+"Fraction"],m=this[d].rounding;this[d][f+"Dragged"]=a.startnum-c;this[d][f+"Position"]=c;if(!e){h||(k=-k,g=-g);var p=(this[d][f+"Invert"]?k-c-g:c-g)/(k-g)*(this.totalItems-1);c=Math[m](p)}if(c!=this[d].num||l)0<=c&&c<=this.totalItems-1?(a=l?"fraction":f,this[d].fraction=this.calculateFraction(p,m),this.setState(c,d,!0,!h,h,!0,a)):this[d].cycle&&(c=0>c?this.totalItems+c:c-this.totalItems,this.setState(c,
